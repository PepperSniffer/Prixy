 ...
 */
class objectif extends \PrixyBundle\Entity\objectif implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PrixyBundle\\Entity\\objectif' . "\0" . 'id', '' . "\0" . 'PrixyBundle\\Entity\\objectif' . "\0" . 'libelle', '' . "\0" . 'PrixyBundle\\Entity\\objectif' . "\0" . 'formation'];
        }
