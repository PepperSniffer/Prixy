 ...
 */
class session_formation extends \PrixyBundle\Entity\session_formation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PrixyBundle\\Entity\\session_formation' . "\0" . 'id', '' . "\0" . 'PrixyBundle\\Entity\\session_formation' . "\0" . 'date', '' . "\0" . 'PrixyBundle\\Entity\\session_formation' . "\0" . 'formation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (session_formation $proxy) {
