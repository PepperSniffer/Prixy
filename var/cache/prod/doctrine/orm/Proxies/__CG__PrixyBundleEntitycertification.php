 ...
 */
class certification extends \PrixyBundle\Entity\certification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PrixyBundle\\Entity\\certification' . "\0" . 'id', '' . "\0" . 'PrixyBundle\\Entity\\certification' . "\0" . 'libelle', '' . "\0" . 'PrixyBundle\\Entity\\certification' . "\0" . 'formation'];
        }
